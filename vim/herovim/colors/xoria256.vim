...
hi StatusLine   ctermfg=234  guifg=#1c1c1c ctermbg=239 guibg=#4e4e4e cterm=bold gui=bold
" status lines of not-current windows
hi StatusLineNC ctermfg=237 guifg=#3a3a3a ctermbg=235 guibg=#3a3a3a cterm=none gui=none
